...
async function run() {
    ...
    const payload = {
        ...
        client: {
            ...
            lastName: "PRUEBA",
            email: "juan@test.com",
            phoneNumber: "3001234567" // Expert says phoneNumber
        },
        items: [{ sku: "1", name: "TEST", quantity: 1, unitPrice: 150000, category: "Fashion" }]
    };

    const url = `https://api.addi.com/v1/allies/${ALLY_SLUG}/applications`;
    console.log(`Testing: ${url} with phoneNumber`);
